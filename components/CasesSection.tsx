...
const CASES = [
  ...
  },
  {
    type: "Наш кейс",
    city: "Москва",
    title: "Исследования для бизнеса",
    problem: "Нужны были предсказуемые заявки на исследования поддержки без холодных звонков.",
    metrics: [
      { v: "24", l: "заявки за квартал" },
      { v: "890 ₽", l: "стоимость заявки" },
    ],
